<template>
	<view class="uni-searchbar">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box" @click="searchClick">
			...
			<!-- #endif -->
			<input v-if="show" :focus="showSync" :placeholder="placeholder" placeholder-style="font-size:20px;" :maxlength="maxlength" @confirm="confirm" class="uni-searchbar__box-search-input"
